...
derived-evidence are maintained in a private GitHub repository:
\url{https://github.com/omair-khan2232/Auditing-crop-host-supervision}. Reviewer
access will be provided on special permission through the authors or the
editorial office, including the final placeholder-class sensitivity output.

This work is original, has not been published previously, is not under
consideration elsewhere, and has been approved by all authors. All authors have
reviewed the manuscript, meet the journal's authorship criteria, and agree to be
accountable for the work. The competing interest, funding, data availability,
CRediT, and LLM use declarations are included in the submission files.
